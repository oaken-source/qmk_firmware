...
const key_override_t o_key_override = ko_make_basic(MOD_BIT(KC_RALT), KC_O, RALT(KC_P));
const key_override_t u_key_override = ko_make_basic(MOD_BIT(KC_RALT), KC_U, RALT(KC_Y));
